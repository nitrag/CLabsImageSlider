...
public class CLabsImageSlider:UIView,updateUI
{
    ...
    public weak var sliderDelegate: imageSliderDelegate? = nil
    ...
    {
        let leftSwipe   =   UISwipeGestureRecognizer(target: self, action: #selector(CLabsImageSlider.swipeRight))
    ...
    var rightSwipe : UISwipeGestureRecognizer
    {
        ...
        return UISwipeGestureRecognizer(target: self, action: #selector(CLabsImageSlider.swipeLeft))
    }
...
public class imageData {
    ...
    var imageUrl    :   String
    var isloading   =   Bool()
    public weak var delegate: updateUI? = nil
